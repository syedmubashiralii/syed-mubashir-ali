...
const Hero = () => {
  return (
    <section 
      id="home" 
      className="min-h-screen flex flex-col justify-center pt-20 pb-10 bg-gradient-to-br from-portfolio-navy to-portfolio-navy/90"
    >
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 text-white space-y-6 mb-10 md:mb-0">
            <h1 className="font-bold">
              ...
              <span className="text-5xl md:text-6xl lg:text-7xl">Your Name</span>
            </h1>
            <h2 className="text-xl md:text-2xl lg:text-3xl text-portfolio-gray font-medium">
              Software Developer
            </h2>
            <p className="text-lg text-gray-300 max-w-lg">
              I specialize in building modern web applications and creating exceptional digital experiences.
            </p>
